...
import { NonConformity, StatutNonConfirmity, TypeNonConformity } from 'src/models/Inspection.model';
import Swal from 'sweetalert2';
import { NonconformityService } from '../services/nonconformity.service';

@Component({
  selector: 'app-non-conformity-edit',
  templateUrl: './non-conformity-edit.component.html',
  styleUrls: ['./non-conformity-edit.component.css']
})
