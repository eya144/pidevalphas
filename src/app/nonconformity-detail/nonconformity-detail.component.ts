...
import { ActionCorrective, Inspection, NonConformity } from '../models/Inspection.model';
import Swal from 'sweetalert2';
import { ActionCorrectiveService } from '../services/action-corrective.service';

@Component({
  selector: 'app-nonconformity-detail',
  templateUrl: './nonconformity-detail.component.html',
  styleUrls: ['./nonconformity-detail.component.css']
})
