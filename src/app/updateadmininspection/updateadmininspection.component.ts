...
import { Inspection, TypeNonConformity, StatusInspection, TypeInspection } from '../models/Inspection.model';
import Swal from 'sweetalert2';

@Component({
  selector: 'app-updateadmininspection',
  templateUrl: './updateadmininspection.component.html',
  styleUrls: ['./updateadmininspection.component.css']
})
export class UpdateadmininspectionComponent implements OnInit {
